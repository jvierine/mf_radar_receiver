...
Doppler RTIs into one two-panel product for the latest 15 minutes over
0–300 km. Five consecutive two-second metadata records are grouped for every
output column. Every time-range cell is fitted. The three dipoles share one
Doppler frequency but retain independent complex amplitudes. No SNR,
