...
def process_rows() -> list[dict]:
    ...
    doppler_timer_active = subprocess.run(
    ...
    result.append(
        {
            "name": "doppler_timer",
            "label": "Realtime fitted-Doppler processor timer",
            "alive": doppler_timer_active,
            "pid": None,
        }
    )
    return result
...
def main() -> None:
    ...
    optional = (
        ...
        plot_dir / "latest_fading_ccf_diagnostics_15m.png",
        plot_dir / "latest_fading_wind_48h.png",
        plot_dir / "latest_fading_wind_quality_48h.png",
        plot_dir / "latest_fading_wind_validation_48h.png",
    )
